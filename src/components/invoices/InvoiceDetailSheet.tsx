    ...
    <AnimatePresence>
      ...
      {isOpen && invoice && (
        ...
        >
          ...
          {actionSuccess && (
            <div className="mt-4 flex items-center gap-2 rounded-lg bg-emerald-50 p-3 text-xs font-medium text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300">
          ...
          {/* Invoice Totals */}
          <div className="mt-4 space-y-2 rounded-lg bg-slate-50/80 p-3.5 text-xs dark:bg-slate-900/40">
